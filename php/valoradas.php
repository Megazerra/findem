...
$sql = "SELECT DISTINCT dis.nombre, dis.descripcion, dis.direccion, dis.latitud, dis.longitud, dis.horario, dis.logo, dis.href FROM discoteca dis JOIN valoracion val ON (val.idDiscoteca = dis.idDiscoteca) ORDER by val.nota desc LIMIT 3";
